...
public class ImageUtil {
	...
	public static BufferedImage forwardIcon;
	...
	public static void init(){
		try {
			...
			backIcon = ImageIO.read(ImageUtil.class.getClassLoader().getResource("com/mh/ui/images/back.png"));
			homeIcon = ImageIO.read(ImageUtil.class.getClassLoader().getResource("com/mh/ui/images/home.png"));
		} catch (IOException e) {
