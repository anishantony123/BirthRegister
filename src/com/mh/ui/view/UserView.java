...
public class UserView extends JPanel{
	...
	public UserView() {
		...
		JLabel lblNewLabel = new JLabel("Name of Patient");
		...
		GridBagConstraints gbc_lblHus = new GridBagConstraints();
		gbc_lblHus.anchor = GridBagConstraints.WEST;
		gbc_lblHus.insets = new Insets(0, 0, 5, 5);
		gbc_lblHus.gridx = 1;
		gbc_lblHus.gridy = 2;
		add(lblHusband, gbc_lblHus);
		
		husband = new JTextField();
		husband.setFont(new Font("Arial",Font.BOLD,13));
		GridBagConstraints gbc_husband = new GridBagConstraints();
		gbc_husband.gridwidth = 1;
		gbc_husband.anchor = GridBagConstraints.NORTH;
		gbc_husband.fill = GridBagConstraints.HORIZONTAL;
		gbc_husband.insets = new Insets(0, 0, 5, 5);
		gbc_husband.gridx = 3;
		gbc_husband.gridy = 2;
		add(husband, gbc_husband);
		...
		JLabel lblNewLabel_2_2 = new JLabel("DOB");
		GridBagConstraints gbc_lblNewLabel_2_2 = new GridBagConstraints();
		gbc_lblNewLabel_2_2.anchor = GridBagConstraints.NORTHWEST;
	...
	public User getUser() {
		...
		user.setHusband(husband.getText());
		return user;
	}
	protected boolean validateThis() {//I think Here is Validation doing **
		getUser();
		if(resultList == null){
		...
		hasErrors = Validator.validateSuper(this,resultList);//here t
	...
	public void setUser(User user) {
		...
		if(this.user!=null){
			...
			husband.setText(user.getHusband());
		}
