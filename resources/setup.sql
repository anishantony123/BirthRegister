...
CREATE TABLE `hospital`.`users` (
  ...
  `diaganosis` varchar(300) DEFAULT NULL,
  `center` varchar(300) DEFAULT NULL,
  ...
  `care_off` varchar(300) DEFAULT NULL,
  `informer` varchar(300) DEFAULT NULL,
...
CREATE TABLE `hospital`.`user_data` (
  ...
  `DATAFILE_NAME` varchar(100) DEFAULT NULL,
